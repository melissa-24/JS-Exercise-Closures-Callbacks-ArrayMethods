...
function getFullNames(runners) {
  let name = [];
  runners.forEach(element => name.push(element.last_name + ", " + element.first_name));
  return name;
}
...
function tallyUpDonations(runners) {
  let startValue = 0;
  let sum = runners.reduce(function(totalValue, currentValue){
